...
for(let i=0;i<obj.length;i++)
{
  ...
  var S_no = 1;
  S_no+=i;
  document.write('<tr id="tr"><td >'+S_no+'</td><td id="data">'+client.fname+'</td><td id="data1">'+client.lname+'</td><td id="data2">'+client.email+'</td><td id="data3">'+client.dob+'</td><td id="data4">'+client.website+'</td><td id="data5">'+client.mobilenumber+'</td><td id="data6">'+client.work+'</td><td id="data7">'+client.Gender+'</td><td id="data8">'+client.Address+'</td><td id="data9">'+client.Groups+'</td><td id="data10">'+client.messager+'</td><td id="data11">'+client.state+'</td></tr>');
}
function deleteRow() 
{
